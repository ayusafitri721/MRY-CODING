...
<body class="bg-white text-slate-800">
    ...
    <main class="">
            ...
            <div class="max-w-7xl mx-auto px-6 py-16">
                ...
                <div class="mt-8 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div class="bg-white p-6 rounded-lg shadow-sm">
                        <div class="text-[#1E88FF] text-2xl">📚</div>
        ...
        <section class="bg-white">
            <div class="max-w-6xl mx-auto px-6 py-16">
                ...
                <div class="mt-8 flex flex-col sm:flex-row items-center justify-between gap-6">
                    <div class="flex-1">
                        <ol class="flex flex-col sm:flex-row items-start sm:items-center gap-6">
                            <li class="flex items-center gap-4">
                                <div class="w-10 h-10 rounded-full bg-[#E8F2FF] flex items-center justify-center text-[#1E88FF] font-semibold">1</div>
                                <div>
                                    <div class="font-semibold">Daftar akun</div>
                                    <div class="text-sm text-slate-500">Buat profil singkat.</div>
                                </div>
                            </li>
                            <li class="flex items-center gap-4">
                                <div class="w-10 h-10 rounded-full bg-[#E8F2FF] flex items-center justify-center text-[#1E88FF] font-semibold">2</div>
                                <div>
                                    <div class="font-semibold">Pilih kelas</div>
                                    <div class="text-sm text-slate-500">Pilih jalur belajar yang cocok.</div>
                                </div>
                            </li>
                            <li class="flex items-center gap-4">
                                <div class="w-10 h-10 rounded-full bg-[#E8F2FF] flex items-center justify-center text-[#1E88FF] font-semibold">3</div>
                                <div>
                                    <div class="font-semibold">Belajar & latihan</div>
                                    <div class="text-sm text-slate-500">Ikuti materi dan tugas.</div>
                                </div>
                            </li>
                        </ol>
                    </div>
                    <div class="flex-1">
                        <ol class="flex flex-col sm:flex-row items-start sm:items-center gap-6">
                            <li class="flex items-center gap-4">
                                <div class="w-10 h-10 rounded-full bg-[#E8F2FF] flex items-center justify-center text-[#1E88FF] font-semibold">4</div>
                                <div>
                                    <div class="font-semibold">Lihat progress</div>
                                    <div class="text-sm text-slate-500">Pantau dashboardmu.</div>
                                </div>
                            </li>
                            <li class="flex items-center gap-4">
                                <div class="w-10 h-10 rounded-full bg-[#E8F2FF] flex items-center justify-center text-[#1E88FF] font-semibold">5</div>
                                <div>
                                    <div class="font-semibold">Selesai & sertifikat</div>
                                    <div class="text-sm text-slate-500">Terima bukti kompetensi.</div>
                                </div>
                            </li>
                        </ol>
                    </div>
        ...
        <footer class="bg-slate-800 text-slate-200">
            <div class="max-w-7xl mx-auto px-6 py-8 flex flex-col md:flex-row items-start justify-between gap-6">
                <div>
                    <div class="text-white font-semibold">MRY Code</div>
                    <div class="text-sm mt-2">hello@mrycode.id</div>
                </div>
                <div class="flex gap-4">
                    <a href="#" class="text-slate-200 hover:text-white">Instagram</a>
                    <a href="#" class="text-slate-200 hover:text-white">Twitter</a>
                    <a href="#" class="text-slate-200 hover:text-white">LinkedIn</a>
                </div>
                <div class="text-sm">© 2026 MRY Code. All rights reserved.</div>
            </div>
        </footer>
    </main>
</body>
